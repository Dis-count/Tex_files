...
First, LP (\ref{eqn:SLC}) is a \textcolor{red}{linear programming involving an exponential number of constraints.}
...
Compared with the LP approach in \cite{leastcore2018}, the LRB algorithm is effective since, \textcolor{red}{for those integer linear programmings having no integrality property,} Lagrangian bounds are sharper than linear relaxation bounds.
