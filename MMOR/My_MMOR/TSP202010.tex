...
\textcolor{red}{It is not a restricted problem.}
expressed as
...
\textcolor{red}{In the literature, the initial Lagrangian multipliers is set to 1, and the iteration equation is
$\lambda^{t+1} = \max\{ \lambda^t + \theta s^t, 0\}, t = t +1$.
}
